...
5. **(2026-09-27 재검토로 추가) 운영 전 우선 수정** — ①sklearn 버전 고정 ②UCL 5대 리그 밖 팀 안내 ③표시 정확도를 LR 값으로 ④players.json 덮어쓰기 방지는 2026-09-27 완료(10번 참고). 남은 것: UCL 밖 팀 예측 지원(UCL 경기만으로 스탯 계산), 순위 예측 시뮬레이션을 현재 승점+남은 일정 기준으로(5.4), 학습 피처 누수·시간순 검증.
